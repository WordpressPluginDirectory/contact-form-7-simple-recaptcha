...
function cf7sr_recaptcha_v3_form_tag_handler( $tag ) {
...
function cf7sr_register_recaptcha_v3_form_tag() {
    wpcf7_add_form_tag(
        'cf7sr_v3_recaptcha',
        'cf7sr_recaptcha_v3_form_tag_handler',
        array( 'display-block' => true )
    );
}
add_action( 'wpcf7_init', 'cf7sr_register_recaptcha_v3_form_tag' );

function cf7sr_verify_recaptcha_v3( $result, $tag ) {
...
add_filter( 'wpcf7_validate_cf7sr_v3_recaptcha', 'cf7sr_verify_recaptcha_v3', 20, 2 );
